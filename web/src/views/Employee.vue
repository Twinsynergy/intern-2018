          ...
          <template slot="items" slot-scope="props">
            ...
            <td class="text-xs-centert">
              <v-btn
                ...
                icon
                color="black"
                v-bind:to="{name: 'empPosition', params: {empID: props.item.id }}"
              >
            ...
            <td class="text-xs-centert">
              <v-btn
                ...
                icon
                color="green"
                v-bind:to="{name: 'empBenefit', params: {empID: props.item.id }}"
              >
            ...
            <td class="text-xs">
              <v-btn
                ...
                icon
                color="info"
                v-bind:to="{name: 'empdetail', params: {empID: props.item.id }}"
              >
              ...
              <v-btn
                ...
                icon
                color="red"
                @click="(selectedData.id = props.item.id,selectedData.name = props.item.emp_name),dialogDel() "
              >
...
export default {
  ...
  methods: {
    getData: function() {
      axios
        .get("http://35.198.219.154:1337/emp/datatable", {
    ...
    costButton: function() {
      this.$router.push("/emp/cost");
    },
    deleteData: function() {
      this.axios
        .post("http://35.198.219.154:1337/emp/delete", this.selectedData, {
          headers: { Authorization: `${localStorage.tokenkey}` }
        })
        .then(response => {
