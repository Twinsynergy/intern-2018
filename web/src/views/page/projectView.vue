...
export default {
  ...
  methods: {
    deleteDataAddit: function() {
      this.axios
        .post(
          "http://178.128.80.240:3030/projectaddit/delete",
    ...
    projectaddit: function() {
      let apiURL = "http://178.128.80.240:3030/project/projectaddit/";
      let getID = this.$route.params.projectID;
      let view = "/view";
      axios
        .get(apiURL + getID + view, {
    ...
    saveDataAddit: function() {
      let apiURL = "http://178.128.80.240:3030/projectaddit/create";
      this.axios
